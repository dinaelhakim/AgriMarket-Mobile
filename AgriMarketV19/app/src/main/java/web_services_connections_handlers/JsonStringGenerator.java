...
import reguest_parameters_pojos.GetUserParam;
import reguest_parameters_pojos.LogOutParam;
import reguest_parameters_pojos.SearchByOfferLocationParam;
import reguest_parameters_pojos.SearchLimitedOffersByProductNameParam;
...
public class JsonStringGenerator {
    ...
    public static String getGetLimitedOffersParam(int productId, int sortType , int pageNo) {

        GetLimitedOffersParam param =new GetLimitedOffersParam(productId,pageNo,sortType);
        Gson gson = new Gson();
        String json = gson.toJson(param);
        return json;
    ...
    public static String getSearchLimitedOffersParam(String productName, int sortType , int pageNo) {

        SearchLimitedOffersByProductNameParam param =new SearchLimitedOffersByProductNameParam(productName,pageNo,sortType);
        Gson gson = new Gson();
        String json = gson.toJson(param);
        return json;
    ...
    public static String getGetUserParam(int userId) {

        GetUserParam param=new GetUserParam(userId);
        Gson gson = new Gson();
        String json = gson.toJson(param);
        return json;

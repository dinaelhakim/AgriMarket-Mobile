package luncher.SideMenu.side_menu_activities.profile;
...
import luncher.SideMenu.side_menu_activities.profile.user_offers.GetMyOffersActivity;
    ...
    private void setListenerForGetOffersTextView() {
        getOffers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Profile.this,GetMyOffersActivity.class);

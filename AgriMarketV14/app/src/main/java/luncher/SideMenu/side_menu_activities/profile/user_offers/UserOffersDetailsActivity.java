...
public class UserOffersDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OfferClass offerObj=(OfferClass)intent.getSerializableExtra("offer");
    ...
    private void setButtonListener() {
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UserOffersDetailsActivity.this, GetMyOffersActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case  android.R.id.home:
                Intent intent = new Intent(this, GetMyOffersActivity.class);
                startActivity(intent);
                finish();
                break;
        }

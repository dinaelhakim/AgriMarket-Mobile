...
//------------------------------------------------------------------
        ...
        ArrayAdapter<String> locationAdapter=new ArrayAdapter(Location.this, android.R.layout.simple_spinner_item,locations);
        locationSpinner.setAdapter(locationAdapter);

        imageviewVoice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mPlayer = MediaPlayer.create(Location.this, R.raw.hello);
                mPlayer.start();
            }
        });
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Location.this,userId.toString(),Toast.LENGTH_LONG).show();
